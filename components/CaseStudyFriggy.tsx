...
const features = [
  {
    ...
    image: "/images/friggy-onboarding.png",
  },
  {
    id: 1,
    title: "For You Feed",
  ...
  },
  {
    ...
    image: "/images/friggy-player.png",
  },
  {
    id: 3,
    ...
    image: "/images/friggy-search.png",
  },
  {
    id: 4,
    ...
    image: "/images/friggy-profile.png",
  },
];
      ...
      <div className="w-full max-w-[1200px] py-24">
        ...
        <section className="mb-24">
          ...
          <div className="flex flex-wrap gap-6 mb-8">
            <div>
              ...
              <p className="text-sm text-[#888580]">Product Designer (pair with 1 designer)</p>
            </div>
            <div>
              <p className="text-xs uppercase tracking-widest text-[#888580] mb-1">Team</p>
              <p className="text-sm text-[#888580]">PM, 2 Designers, Developers, QA, Graphic Team</p>
            </div>
            <div>
              <p className="text-xs uppercase tracking-widest text-[#888580] mb-1">Status</p>
              <p className="text-sm text-[#888580]">Live on iOS</p>
            </div>
          </div>
        ...
        <FadeIn>
          <div className="w-full aspect-video bg-neutral-100 rounded-2xl flex items-center justify-center">
            {/* Replace with: <img src="/images/friggy-hero.png" alt="Friggy app" className="w-full h-full object-cover rounded-2xl" /> */}
        ...
        <FadeIn>
          <section className="max-w-[720px]">
            ...
            <p className="text-[18px] leading-[30px] text-[#888580] mb-8">
