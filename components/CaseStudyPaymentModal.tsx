      ...
      <div style={{ maxWidth: "1080px", margin: "0 auto", padding: "0 48px" }} className="py-24">
        ...
        <FadeIn>
          <div className="mb-32 w-full">
            ...
            <p className="max-w-full text-base md:text-xl leading-relaxed overflow-hidden" style={{ maxWidth: "680px", color: "var(--secondary)" }}>
        ...
        <FadeIn delay={0.05}>
          <div className="mb-28 w-full">
            <h2 className="mb-6 w-full" style={{ fontFamily: "var(--font-dm-serif)", fontWeight: 400, color: "var(--foreground)", fontSize: "clamp(26px, 3vw, 34px)", lineHeight: 1.2 }}>
              The product
            </h2>
            <p className="text-base md:text-lg overflow-hidden" style={{ color: "var(--secondary)", lineHeight: 1.8, maxWidth: "680px" }}>
        ...
        <FadeIn delay={0.1}>
          <div className="flex flex-col md:flex-row md:items-center gap-6 md:gap-16 mb-28 w-full">
            <div className="w-full md:w-auto">
              <p className="mb-1 text-4xl sm:text-6xl md:text-[72px]" style={{ fontFamily: "var(--font-dm-serif)", fontWeight: 400, color: "var(--foreground)" }}>+3.51%</p>
              <p className="text-xs uppercase tracking-widest" style={{ color: "var(--muted)" }}>Trial conversion lift</p>
            </div>
            <div className="hidden md:block flex-shrink-0" style={{ width: "1px", height: "60px", background: "var(--border)" }} />
            <div className="w-full md:w-auto">
              <p className="mb-1 text-3xl sm:text-5xl md:text-[48px]" style={{ fontWeight: 600, color: "var(--foreground)" }}>73.6K</p>
              <p className="text-xs uppercase tracking-widest" style={{ color: "var(--muted)" }}>Users per variation</p>
            </div>
          </div>
        </FadeIn>
        ...
        {/* HERO IMAGE */}
        <FadeIn delay={0.15}>
          <div className="w-full rounded-2xl mb-28 overflow-hidden" style={{ width: "100%", maxWidth: "100%", background: "#f0ece5", border: "1px solid var(--border)" }}>
            <img
        ...
        <FadeIn>
          <div className="mb-28 w-full">
            <h2 className="font-medium mb-6 w-full" style={{ color: "var(--foreground)", fontSize: "clamp(22px, 4vw, 40px)" }}>The approach</h2>
            <p className="text-base md:text-lg overflow-hidden mb-4" style={{ color: "var(--muted)", lineHeight: "1.6", maxWidth: "680px" }}>
            ...
            <p className="text-base md:text-lg overflow-hidden" style={{ color: "var(--muted)", lineHeight: "1.6", maxWidth: "680px" }}>
        ...
        <FadeIn>
          <div className="mb-28 w-full">
            <h2 className="font-medium mb-8 w-full" style={{ color: "var(--foreground)", fontSize: "clamp(22px, 4vw, 40px)" }}>What we tested</h2>
            <div className="flex gap-2 mb-6 flex-wrap">
              {variations.map(v => (
                <button
                  ...
                  style={{
                    border: `1px solid ${active === v.id ? "var(--foreground)" : "var(--border)"}`,
                    color: active === v.id ? "var(--foreground)" : "var(--muted)",
                ...
                >
                  {v.label}
                  {v.winner && (
                    <span className="text-xs px-1.5 py-0.5 rounded-full" style={{ background: "var(--border)", color: "var(--secondary)" }}>Winner</span>
                  )}
                </button>
              ))}
            </div>
            <div className="rounded-2xl p-6" style={{ background: "var(--surface)" }}>
              <p className="mb-6 overflow-hidden" style={{ color: "var(--secondary)", fontSize: "20px", lineHeight: "32px", maxWidth: "680px" }}>{variation.description}</p>
        ...
        <FadeIn>
          <div className="mb-28 w-full">
            <h2 className="font-medium mb-6 w-full" style={{ color: "var(--foreground)", fontSize: "clamp(22px, 4vw, 40px)" }}>Why Variation 2 won</h2>
            <p className="text-base md:text-lg overflow-hidden mb-4" style={{ color: "var(--muted)", lineHeight: "1.6", maxWidth: "680px" }}>
        ...
        <FadeIn>
          <div className="w-full">
            <h2 className="font-medium mb-8 w-full" style={{ color: "var(--foreground)", fontSize: "clamp(22px, 4vw, 40px)" }}>What I took away</h2>
              ...
              {[
                ...
                <FadeIn key={l.n} delay={i * 0.08} className="h-full">
                  <div className="rounded-2xl p-8 h-full" style={{ background: "var(--surface)" }}>
                    ...
                    <p className="mb-0 overflow-hidden" style={{ color: "var(--secondary)", fontSize: "15px", lineHeight: "24px", maxWidth: "680px" }}>{l.body}</p>
                  </div>
                </FadeIn>
              ))}
            </div>
